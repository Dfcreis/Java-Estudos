...
public class Aluno { public static void main() {
        ...
        aluno.name = sc.nextLine();//informa a primeira nota do aluno
        System.out.println("Digite a primeira nota: ");aluno.nota1 = sc.nextDouble();
